...
| [`pi-dir-permission`](packages/pi-dir-permission) | Confines the file tools to the working directory and opens up anything outside it one dialog at a time; zero runtime dependencies | Published |
