 ...
 * introduce a cycle in the dependency graph. Pure: takes the existing task
 * list and the proposed additions explicitly, so the reducer can ask "would
 * this update cycle?" without mutating state first.
 */
